...
<body>
  ...
  if ($query->rowCount() > 0) {
    foreach ($results as $result) {
      ...
      <div class="container">
      <div class="row">
        <div class="column gallery"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1); ?>"
            class="img-responsive" alt="image" width="900" height="560"></div>
        <div class="column gallery"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage2); ?>"
            class="img-responsive" alt="image" width="900" height="560"></div>
        <div class="column gallery"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage3); ?>"
            class="img-responsive" alt="image" width="900" height="560"></div>
        <div class="column gallery"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage4); ?>"
            class="img-responsive" alt="image" width="900" height="560"></div>
        <?php if ($result->Vimage5 == "") {

        } else {
          ?>
          <div class="column gallery"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage5); ?>"
              class="img-responsive" alt="image" width="900" height="560"></div>
        <?php } ?>
      </div>
      </div>
            ...
            <div class="col-md-9">
              <div class="main_features">
                <ul>
                  ...
                  <li> <i class="fa" aria-hidden="true"></i>
                    <h3><?php echo htmlentities($result->ModelYear); ?></h3>
                    <p>Reg.Year</p>
                  </li>
                  <li> <i class="fa" aria-hidden="true"></i>
                    <h3><?php echo htmlentities($result->FuelType); ?></h3>
                    <p>Fuel Type</p>
                  </li>

                  <li> <i class="fa" aria-hidden="true"></i>
                    <h3><?php echo htmlentities($result->SeatingCapacity); ?></h3>
                    <p>Seats</p>
                  </li>
                </ul>
              </div>
          ...
          <div class="sidebar_widget">
            ...
            <form method="post">
              ...
              <?php if ($_SESSION['login']) { ?>
                <div class="form-group">
                  <input type="submit" class="btn button-50" name="submit" value="Book Now">
                </div>
              <?php } else { ?>
                <a href="#loginform" class="btn btn-xs uppercase button-50" data-toggle="modal" data-dismiss="modal">Login For
                  Book</a>
              ...
              <div class="col-md-3 grid_listing">
                <div class="product-listing-m gray-bg">
                  ...
                  <div class="product-listing-content">
                    <h5><a
                        href="vehical-detail.php?vhid=<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->BrandName); ?>
