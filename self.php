...
<head>
	...
	<link rel="icon" type="image/png" href="images/HTDT-logo.png">
...
<body>
	<header>
		...
		<div class="head">
			...
			<br>
			<font>HTDT is very customer friendly company where customer service and satisfaction come first.</font>
		</div>
	</header>
	<br><br><br>
	<div class="img" id="Sticky">
		<img src="images/self.jpg" height="40%" width="48%" align="left" style="margin-left:3%;">
	</div>
	...
	<div class="ccr">
		...
		<p class="main" style="margin:2% 5% 0 55%;line-height:2;">
			HTDT is a very customer friendly company where customer service and satisfaction come first.<br>
			HTDT provides self-driven cars to customers at very convenient prices and gives absolutely new and young
		...
		<p class="main" style="color:black">
			<b>HTDT provides selfdriven car in TPHCM/Vietnam. Selfdriven concept has been highly developed in Vietnam as it quite new concept as well.</b><br><br>
			...
			Driving in Vietnam should be a safe and enjoyable experience. If you have never driven in Vietnam before you should become familiar with the rules of our roads.
			The Vietnamn Transport Agency has issued some key driving tips which you should read before setting on your journey.<br><br>
			But first, as you will appreciate when you arrive in Vietnam – you’ve come a long way!! HTDT strongly suggest if you have come on a
		...
		<p class="main" style="color:black">
			...
			It’s easy to underestimate traveling times in Vietnam. Distances may seem short on paper, but Vietnamn roads may be narrower than you’re used to.<br><br>
		</p>
		<p class="main" style="color:black">
		<ul style="list-style: circle;">
		...
		<p class="main" style="color:black">
			...
			Most roads in Vietnam have a single lane each way, and some provide passing lanes at regular intervals – these should be used where possible when overtaking. You must not cross a solid yellow line on your side of the center
		...
		<p class="main" style="color:black">
			Contact
			<br><br><b>
				Phone Number:<font color="#00afe5"> +01</font> 3456789
				<br><br>
				Email Address:<font color="#00afe5"> tdtu@gmail.com</font>
				<br><br>
	...
	<div class="ccr1">
		...
		<p class="main" style="color:black;margin-left:2%;">
			Contact
			<br><br><b>
				Phone Number:<font color="#00afe5"> +01</font> 23456789
				<br><br>
				Email Address:<font color="#00afe5"> tdtu@gmail.com</font>
				<br><br>
				Reservation Hours: Monday to Sunday 24 hours</b>
