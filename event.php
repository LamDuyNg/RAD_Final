...
<body>
	<header>
		...
		<div class="head">
			...
			<br>
			<font>We provides car on rent for conferences and boared meeting in TPHCM</font>
		</div>
	</header>
	<br> <br> <br>
	<div class="img" id="Sticky">
		<img src="images/event.jpg" style="height:auto;width:43%;margin-left:60px;" align="left">
	</div>
	<div class="break"><img src="images/event.jpg" style="height:auto;margin-left:10%;margin-right:10%;margin-top:1%;" align="left"><br></div>
	<script>
	...
	<div class="ccr">
		...
		<p class="main" style="margin:2% 0 0 50%;">
			We provides car on rent for conferences and boared meeting in TPHCM
