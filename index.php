...
<body>
	...
	<table class="tabl2" bgcolor="8B93FF" height="100px">
		<tr>
			<td>
	...
	<a id="service">
		...
		<div style="margin-top:5%;">
			<table style="width:82%;margin:auto;">
				<tr>
					<td>
						<img src="images/carp.png" style="float:left; height:auto;">
						<h1 style="font-size:1.4vw; color:black;">CAR RENTAL SERVICE</h1>
						<h3 style="color:grey; font-size:0.9vw; margin-left:45px; text-align:left;">
							HTDT offers to make it easy for clients to get the right car at
							the right price at the right time. If you are looking for car rental service in TPHCM/Vietnam or minibusses hire
							services, then our company is the right option for you. Get the best deal on booking of luxury car and coaches in TPHCM.
						</h3>
						<a href="rental.php" style="text-decoration:none;">
							<h3 class="readmore">READ MORE</h3>
						</a>
					</td>
					<td>
						<img src="images/busi.png" style="float:left;">
						<h1 style="font-size:1.4vw; color:black;">CORPORATE CAR RENTAL</h1>
						<h3 style="color:grey; font-size:0.9vw; margin-left:45px; text-align:left;">
							Our planning, communication and tracking support, make us accessible to you whenever and
						...
						<a href="corporate.php" style="text-decoration:none;">
							<h3 class="readmore">READ MORE</h3>
						</a>
					</td>
					<td>
						<img src="images/marriage.png" style="float:left;">
						<h1 style="font-size:1.4vw; color:black;">WEDDING CAR RENTAL</h1>
						<h3 style="color:grey; font-size:0.9vw; margin-left:45px; text-align:left;">
							HTDT is emerging car rental company in TPHCM/Vietnam. We have been known in industry
							for our 100% customer satisfaction. We think for a special occasion we need the right car at right prices, HTDT provides
							the best car accordingly the customer requirement.
						</h3>
						<a href="wed.php" style="text-decoration:none;">
							<h3 class="readmore">READ MORE</h3>
						</a>
					</td>
				</tr>
				<tr>
					<td>
						...
						<h1 style="font-size:1.4vw; color:black;">EVENT TRANSPORTATION</h1>
						<h3 style="color:grey; font-size:0.9vw; margin-left:45px; text-align:left;">
							While customer is traveling with us we care the all needs of our clients. We offer
							...
							choices. Online Booking and Book-keeping for better management.
						</h3>
					...
					<td>
						<img src="images/self.png" style="float:left;">
						<h1 style="font-size:1.4vw; color:black;">SELFDRIVE CAR RENTAL</h1>
						<h3 style="color:grey; font-size:0.9vw; margin-left:45px; text-align:left;">
							HTDT is a very customer friendly company where customer service and
							satisfaction come first. HTDT provides self-driven cars to customers at very convenient prices and gives
							absolutely new and young well-maintained fleet for hassle-free and memorable driving experience.
						</h3>
						<a href="self.php" style="text-decoration:none;">
							<h3 class="readmore">READ MORE</h3>
						</a>
					</td>
					<td>
						<img src="images/one.png" style="float:left;">
						<h1 style="font-size:1.4vw; color:black;">ONE WAY DROP SERVICE</h1>
						<h3 style="color:grey; font-size:0.9vw; margin-left:45px; text-align:left;">
							HTDT is providing One Way Drop Services From TPHCM/Vietnam. We offer
							to make it easy for clients to get the right car at the right price at the right time. If you are looking for
							car rental service in TPHCM/Vietnam, we are the right choice for you.
						</h3>
						<a href="one.php" style="text-decoration:none;">
							<h3 class="readmore">READ MORE</h3>
						</a>
					</td>
				</tr>
		...
		<div class="context">
			...
			<a href="contact.php"><button>
					<h1 style="color:white;font-size:1vw;margin:10px 10px 10px 10px">Enquire Now</h1>
				</button></a>
		</div>
		<footer>
			<table style="height:10%;">
				...
				<tr bgcolor="#252525">
					<td class="widget">
						<p class="text">HTDT is one of the reputed Travel<br>
					...
					<td class="widget">
						<p class="text1">Address: TPHCM, Vietnam<br>
							...
							<img src="images/message.png">&emsp;tdtu@gmail.com
						</p>
					</td>
				</tr>
				<tr bgcolor="black">
					<td class="copyright" colspan="2">
						<font>&copy;Copyright 2024 All Right Reserved</font>
					</td>
				</tr>
			</table>
		</footer>
