...
<body onload="Display()">
	<header>
		...
		<div class="head">
			...
			<font>It's Bad Manners To Keep A Vocation Waiting</font; </div>
	</header>
	<iframe id="Sticky" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15680.09560268348!2d106.6997639!3d10.7326399!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317528b2747a81a3%3A0x33c1813055acb613!2zxJDhuqFpIGjhu41jIFTDtG4gxJDhu6ljIFRo4bqvbmc!5e0!3m2!1svi!2s!4v1718031226815!5m2!1svi!2s" width="100%" height="500" frameborder="0">Please Check your Network</iframe>
	<script>
	...
	<form method="post" enctype="multipart/form-data" autocomplete="on">
			...
			<tr>
				<td>Date:<input type="date" name="date" id="date" onchange="CheckDate()" style="margin-left:5%;">
					<div id="Popup" class="popup">Sorry!The vehicle is already booked on the corresponding date.
						Select a different date or book another vehicle.</div>
				</td>
			</tr>
			<tr>
				<td colspan="2">Upload Driving License
					<input type="file" id="accept" accept="image/*" name="license">
				</td>
			</tr>
		</table>
		...
		<div class="head1">
			<h3 style="font-size:2vw;">Please fill the form below</h3>
		</div>
		<table class="form">
			<tr>
