        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-3 col-md-2">
                    <div class="brandName"> <a href="index.php" class="brandNameStyle">
                            <h4>CAR RENTAL VN</h4>
                        </a> </div>
                </div>
                <div class="col-sm-9 col-md-10 row">
