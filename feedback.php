...
<body onunload="clear()">
	...
	<table class="form" id="finalmessage" border="0">
		<tr>
			<td style="width:400vh">
				<div class="thank" style="color:#7DC248;margin-top:40px;padding:0;width:98%;">SUCCESS!</div>
				<div class="thank" style="color:#4D5656;margin:2% 0 4% 0;padding:0;width:100%;font-size:1.4vw;">You successfully created your booking</div>
			</td>
		</tr>
		<tr>
	...
	<div class="thank">
		<font>Thank You For Sharing Your Experience</font>
	</div>
	<img class="taxi" src="images/taxi.jpg"><br>
	<div class="thank" id="t">
		<font>Feel Free To Browse Through Our Website</font>
	</div>
	<table class="form">
		<form method="post">
			<tr>
