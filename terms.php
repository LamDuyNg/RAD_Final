...
<body>
	...
	<ol style="margin:3% 0 3% 3%;list-style-type: decimal;color: #808080;">
		...
		<li>The customer agrees and accept that the use of the services given by HTDT is at the sole risk of the
		...
		<li>By any chance, if your flight or train or bus misses HTDT will not be liable for that.</li>
	</ol>
	<p style="margin:5% 0 5% 2%;">The above-mentioned terms and conditions of use and the Privacy Policy constitute the entire agreement between the
		User(s) and HTDT with respect to access to and use of the website and the Services offered by HTDT,
