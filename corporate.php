...
<body>
	...
	<br> <br> <br>
	<div class="img">
		<img src="images/corp.jpg" style="float:left;margin:0 0 50px 30px;width:45%;height:auto;">
	</div>
	<div class="break">
		<img src="images/corp.jpg" style="text-align:center;margin-left:10%;width:80%;height:auto;"><br>
	</div>
	<div class="ccr">
		...
		<p style="color:grey;font-size:1.2vw;text-align:left;margin:20px 80px 0 52%">
			HTDT provides <i>Corporate Travel Management</i> or company cars, a concept adopted by a
			majority of companies for better cost management for their travel requirements.<br><br>
			<b>Commercial Vehicle Leasing In TPHCM, Business Car Rentals In TPHCM, Corporate Car Rentals In TPHCM,
				Innova Hire In TPHCM.</b>
		</p>
	</div>
	<div class="ccr1">
