    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col-sm-8 ml-auto">
                <form class="row">
                    <div class="col-5 p-0">
                        <input type="text" class="form-control pe-5" placeholder="Enter customer name">
                        </div>
                        <div class="col-5">
            ...
            <div class="col-sm-2">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addCustomer">Add customer</button>
            </div>
        </div>
    </div>
        ...
        ?>
            <tr>
                ...
                <th class="d-flex justify-content-around">
                    <button class="button edit-btn" style="border: 0; background-color:white;" data-bs-toggle="modal" data-bs-target="#editCustomer">
                        <i class="bi bi-pencil"></i>
                    </button>
                    
                    <button class="button delete-btn" style="border: 0; background-color:white;" data-bs-toggle="modal" data-bs-target="#deleteCustomer">
    ...
    <div class="modal fade" id="addCustomer" tabindex="-1" aria-labelledby="addCustomerLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="addCustomerForm" class="px-3" action="add_customer.php" method="post">
                    <div class="mb-2">
